...
async function getBundledNativeModulesAsync(projectRoot, sdkVersion) {
  if (sdkVersion === 'UNVERSIONED') {
    ...
    try {
      ...
      _log().default.warn(`Unable to reach Expo servers. Falling back to using the cached dependency map (${_log().default.chalk.bold('bundledNativeModules.json')}) from the package "${_log().default.chalk.bold`expo`}" installed in your project.`);
