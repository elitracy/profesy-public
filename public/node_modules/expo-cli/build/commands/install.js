...
function _default(program) {
  (0, _applyAsyncAction().applyAsyncAction)(program.command('install [packages...]').alias('add').helpGroup('core').option('--npm', 'Use npm to install dependencies. (default when package-lock.json exists)').option('--yarn', 'Use Yarn to install dependencies. (default when yarn.lock exists)').description('Install a module or other package to a project'), () => Promise.resolve().then(() => _interopRequireWildcard(require('./installAsync'))));
}
