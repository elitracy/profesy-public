...
function readAppleTeam(dataBase64) {
  var _profilePlist$TeamIde;

  const profilePlist = parse(dataBase64);
  const teamId = (_profilePlist$TeamIde = profilePlist['TeamIdentifier']) === null || _profilePlist$TeamIde === void 0 ? void 0 : _profilePlist$TeamIde[0];
