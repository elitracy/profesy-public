...
async function openUrlInSimulatorSafeAsync({
  ...
  try {
    if (devClient) {
      ...
      _lastUrl = url;
    } else if (!devClient && (0, _internal().isDevClientPackageInstalled)(projectRoot)) {
...
async function constructDeepLinkAsync(projectRoot, scheme, devClient) {
  if (process.env['EXPO_ENABLE_INTERSTITIAL_PAGE'] && !devClient && (0, _internal().isDevClientPackageInstalled)(projectRoot)) {
