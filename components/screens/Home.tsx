            ...
            <View style={styles.searchContainer}>
                ...
                >
                    ...
                    >
                        ...
                        />
                        {wordEntered &&
                            <Pressable onPress={() => setWordEntered('')}><MaterialIcons name='clear' color='white' size={20} style={{ marginLeft: -30, opacity: 0.5 }} /></Pressable>
                        }
                    </View>
                                        ...
                                        <TouchableOpacity
                                            ...
                                            onPress={() => {
                                                navigation.navigate('Professor', {
                                                    ...
                                                    courseAvgs: value.courseAverages
                                                })
                                                !profHistory
